...
use App\Http\Requests\WprofileRequest as StoreRequest;
use App\Http\Requests\WprofileRequest as UpdateRequest;

class WprofileCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Wprofile');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/wprofile');
